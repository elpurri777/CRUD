                    ...
                    <div class='Ingrese'></div>
						...
						<div class="form-row">
							<div class="form-group col-md-3">
								<input class="form-control" type="number" name="numid" min="9999" max="999999999999" value="" placeholder=" N° FICHA">
							</div>
							<div class="form-group col-md-3">
								<input class="form-control" style="text-transform: uppercase;" type="text" name="PROGRAMA" placeholder="PROGRAMA">
							</div>	
							<div class="form-group col-md-3">
